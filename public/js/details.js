var renterId = sessionStorage.getItem("loggedInRenterId");
var renterName = sessionStorage.getItem("loggedInRenterName");
var hostId = sessionStorage.getItem("clickedhostId");
...
var lastLoggedIn = sessionStorage.getItem("clickedListingRate");
//show image of this listing
var listingImg = $('<img>');
...
//show renter's Name
  $("#renterName").text("Hi "+ renterName + "please make reservation here..");
  ...
  $("#add-btn").on("click", function (event) {
    ...
    if (lastLoggedIn === "host") {
      alert("Please sign in as Renter to make reservation..")
    } else {
